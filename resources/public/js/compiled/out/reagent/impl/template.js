...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__19038__auto__,writer__19039__auto__,opt__19040__auto__){
return cljs.core._write.call(null,writer__19039__auto__,"reagent.impl.template/NativeWrapper");
});
...
var or__18432__auto__ = reagent.impl.template.named_QMARK_.call(null,x);
...
var or__18432__auto__ = reagent.impl.template.hiccup_tag_QMARK_.call(null,x);
if(cljs.core.truth_(or__18432__auto__)){
return or__18432__auto__;
} else {
...
var G__26042 = o;
(G__26042[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__26043__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__26043 = function (var_args){
var args = null;
...
while (G__26044__i < G__26044__a.length) {G__26044__a[G__26044__i] = arguments[G__26044__i + 0]; ++G__26044__i;}
  args = new cljs.core.IndexedSeq(G__26044__a,0);
} 
return G__26043__delegate.call(this,args);};
G__26043.cljs$lang$maxFixedArity = 0;
G__26043.cljs$lang$applyTo = (function (arglist__26045){
var args = cljs.core.seq(arglist__26045);
return G__26043__delegate(args);
});
...
var old_26046 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_26046))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_26046)].join(''):class$));
} else {
}
...
if(cljs.core.not.call(null,(function (){var and__18420__auto__ = (node === document.activeElement);
if(and__18420__auto__){
var and__18420__auto____$1 = reagent.impl.template.has_selection_api_QMARK_.call(null,(node["type"]));
...
if(cljs.core.truth_((function (){var and__18420__auto__ = (jsprops["hasOwnProperty"])("onChange");
...
var G__26049 = jsprops;
(G__26049["defaultValue"] = value);

(G__26049["onChange"] = ((function (G__26049,v,value,on_change){
return (function (p1__26047_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26047_SHARP_);
});})(G__26049,v,value,on_change))
);
...
var vec__26051 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26051,(0),null);
var id = cljs.core.nth.call(null,vec__26051,(1),null);
var class$ = cljs.core.nth.call(null,vec__26051,(2),null);
...
var temp__4659__auto__ = (function (){var G__26055 = cljs.core.meta.call(null,v);
if((G__26055 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__26055);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__26057_26058 = v;
var G__26057_26059__$1 = (((G__26057_26058 == null))?null:reagent.impl.template.key_from_vec.call(null,G__26057_26058));
if((G__26057_26059__$1 == null)){
} else {
(jsprops["key"] = G__26057_26059__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__26062 = cljs.core.meta.call(null,argv);
if((G__26062 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__26062);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__26063 = (((jsprops == null))?{}:jsprops);
(G__26063["key"] = key);
...
var G__26064 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26064;
continue;
}
} else {
...
var n__19346__auto___26065 = a.length;
var i_26066 = (0);
while(true){
if((i_26066 < n__19346__auto___26065)){
(a[i_26066] = reagent.impl.template.as_element.call(null,(a[i_26066])));
...
var a = cljs.core.into_array.call(null,s);
var n__19346__auto___26068 = a.length;
var i_26069 = (0);
while(true){
if((i_26069 < n__19346__auto___26068)){
var val_26070 = (a[i_26069]);
if((cljs.core.vector_QMARK_.call(null,val_26070)) && ((reagent.impl.template.key_from_vec.call(null,val_26070) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26069] = reagent.impl.template.as_element.call(null,val_26070));

var G__26071 = (i_26069 + (1));
i_26069 = G__26071;
continue;
} else {
}
...
if(cljs.core.truth_((function (){var and__18420__auto__ = cljs.core.not.call(null,reagent.impl.component._STAR_non_reactive_STAR_);
if(and__18420__auto__){
return (ctx["no-key"]);
} else {
return and__18420__auto__;
...
var G__26073 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26073) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26073){
...
//# sourceMappingURL=template.js.map?rel=1463305607547