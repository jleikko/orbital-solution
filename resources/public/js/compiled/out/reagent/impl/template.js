...
var G__26823 = o;
(G__26823[reagent.impl.template.cached_prop_name.call(null,k)] = reagent$impl$template$convert_prop_value.call(null,v));
...
return (function() { 
var G__26824__delegate = function (args){
...
return G__26824__delegate.call(this,args);};
...
return G__26824__delegate(args);
});
...
var old_26827 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_.call(null,old_26827))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_26827)].join(''):class$));
} else {
}
...
var G__26830 = jsprops;
(G__26830["defaultValue"] = value);

(G__26830["onChange"] = ((function (G__26830,v,value,on_change){
return (function (p1__26828_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__26828_SHARP_);
});})(G__26830,v,value,on_change))
);
...
var vec__26832 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__26832,(0),null);
var id = cljs.core.nth.call(null,vec__26832,(1),null);
var class$ = cljs.core.nth.call(null,vec__26832,(2),null);
...
var temp__4659__auto__ = (function (){var G__26836 = cljs.core.meta.call(null,v);
if((G__26836 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__26836);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__26838_26839 = v;
var G__26838_26840__$1 = (((G__26838_26839 == null))?null:reagent.impl.template.key_from_vec.call(null,G__26838_26839));
if((G__26838_26840__$1 == null)){
} else {
(jsprops["key"] = G__26838_26840__$1);
}
...
var p = (function (){var temp__4659__auto__ = (function (){var G__26843 = cljs.core.meta.call(null,argv);
if((G__26843 == null)){
return null;
} else {
return reagent.impl.template.get_key.call(null,G__26843);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__26844 = (((jsprops == null))?{}:jsprops);
(G__26844["key"] = key);
...
var G__26845 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__26845;
continue;
}
} else {
...
var n__19346__auto___26846 = a.length;
var i_26847 = (0);
while(true){
if((i_26847 < n__19346__auto___26846)){
(a[i_26847] = reagent.impl.template.as_element.call(null,(a[i_26847])));
...
var a = cljs.core.into_array.call(null,s);
var n__19346__auto___26849 = a.length;
var i_26850 = (0);
while(true){
if((i_26850 < n__19346__auto___26849)){
var val_26851 = (a[i_26850]);
if((cljs.core.vector_QMARK_.call(null,val_26851)) && ((reagent.impl.template.key_from_vec.call(null,val_26851) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26850] = reagent.impl.template.as_element.call(null,val_26851));

var G__26852 = (i_26850 + (1));
i_26850 = G__26852;
continue;
} else {
}
...
var G__26854 = (cljs.core.count.call(null,argv) - first_child);
switch (G__26854) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__26854){
...
//# sourceMappingURL=template.js.map?rel=1463433291112