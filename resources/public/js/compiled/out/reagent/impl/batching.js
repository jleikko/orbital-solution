...
var c_26759 = (a[i]);
if(cljs.core.truth_((c_26759["cljsIsDirty"]))){
(c_26759["forceUpdate"])();
} else {
}
...
var G__26763 = c;
var G__26763__$1 = (((G__26763 == null))?null:(G__26763["props"]));
if((G__26763__$1 == null)){
return null;
} else {
return (G__26763__$1["argv"]);
}
});
...
var G__26765_26766 = (c["cljsRatom"]);
if((G__26765_26766 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__26765_26766);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1463433290836