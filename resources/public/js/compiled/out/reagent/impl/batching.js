...
var or__18432__auto__ = (w["requestAnimationFrame"]);
if(cljs.core.truth_(or__18432__auto__)){
return or__18432__auto__;
} else {
var or__18432__auto____$1 = (w["webkitRequestAnimationFrame"]);
if(cljs.core.truth_(or__18432__auto____$1)){
return or__18432__auto____$1;
} else {
var or__18432__auto____$2 = (w["mozRequestAnimationFrame"]);
if(cljs.core.truth_(or__18432__auto____$2)){
return or__18432__auto____$2;
} else {
var or__18432__auto____$3 = (w["msRequestAnimationFrame"]);
if(cljs.core.truth_(or__18432__auto____$3)){
return or__18432__auto____$3;
} else {
...
var n__19346__auto__ = a.length;
var i = (0);
while(true){
if((i < n__19346__auto__)){
var c_25978 = (a[i]);
if(cljs.core.truth_((c_25978["cljsIsDirty"]))){
(c_25978["forceUpdate"])();
} else {
}
...
reagent.impl.batching.RenderQueue.cljs$lang$ctorPrWriter = (function (this__19038__auto__,writer__19039__auto__,opt__19040__auto__){
return cljs.core._write.call(null,writer__19039__auto__,"reagent.impl.batching/RenderQueue");
});
...
var G__25982 = c;
var G__25982__$1 = (((G__25982 == null))?null:(G__25982["props"]));
if((G__25982__$1 == null)){
return null;
} else {
return (G__25982__$1["argv"]);
}
});
...
var G__25984_25985 = (c["cljsRatom"]);
if((G__25984_25985 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__25984_25985);
}

return reagent.impl.batching.mark_rendered.call(null,c);
});

//# sourceMappingURL=batching.js.map?rel=1463305607247