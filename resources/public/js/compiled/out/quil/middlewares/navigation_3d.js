...
var vec__26911 = axis;
var a_x = cljs.core.nth.call(null,vec__26911,(0),null);
var a_y = cljs.core.nth.call(null,vec__26911,(1),null);
var a_z = cljs.core.nth.call(null,vec__26911,(2),null);
var vec__26912 = v;
var x = cljs.core.nth.call(null,vec__26912,(0),null);
var y = cljs.core.nth.call(null,vec__26912,(1),null);
var z = cljs.core.nth.call(null,vec__26912,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__26913,p__26914){
var vec__26917 = p__26913;
var u1 = cljs.core.nth.call(null,vec__26917,(0),null);
var u2 = cljs.core.nth.call(null,vec__26917,(1),null);
var u3 = cljs.core.nth.call(null,vec__26917,(2),null);
var vec__26918 = p__26914;
var v1 = cljs.core.nth.call(null,vec__26918,(0),null);
var v2 = cljs.core.nth.call(null,vec__26918,(1),null);
var v3 = cljs.core.nth.call(null,vec__26918,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__26919_SHARP_){
return (p1__26919_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__26920_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__26921_SHARP_,angle_lr),angle_ud);
...
var map__26928 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__26928__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__26928__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__26930 = cljs.core._EQ_;
var expr__26931 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__26930.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__26931))){
return straight;
} else {
if(cljs.core.truth_(pred__26930.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__26931))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__26930.call(null,quil.middlewares.navigation_3d.space,expr__26931))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__26930.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__26931))){
return up;
} else {
if(cljs.core.truth_(pred__26930.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__26931))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__26930.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__26931))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__26928,map__26928__$1,up,straight){
return (function (p1__26922_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__26922_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__26928,map__26928__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__26933_SHARP_);
});})(initial_state))
);
});
/**
...
var map__26939_26944 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__26939_26945__$1 = ((((!((map__26939_26944 == null)))?((((map__26939_26944.cljs$lang$protocol_mask$partition0$ & (64))) || (map__26939_26944.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26939_26944):map__26939_26944);
var vec__26940_26946 = cljs.core.get.call(null,map__26939_26945__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_26947 = cljs.core.nth.call(null,vec__26940_26946,(0),null);
var c_y_26948 = cljs.core.nth.call(null,vec__26940_26946,(1),null);
var c_z_26949 = cljs.core.nth.call(null,vec__26940_26946,(2),null);
var vec__26941_26950 = cljs.core.get.call(null,map__26939_26945__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_26951 = cljs.core.nth.call(null,vec__26941_26950,(0),null);
var u_y_26952 = cljs.core.nth.call(null,vec__26941_26950,(1),null);
var u_z_26953 = cljs.core.nth.call(null,vec__26941_26950,(2),null);
var vec__26942_26954 = cljs.core.get.call(null,map__26939_26945__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_26955 = cljs.core.nth.call(null,vec__26942_26954,(0),null);
var p_y_26956 = cljs.core.nth.call(null,vec__26942_26954,(1),null);
var p_z_26957 = cljs.core.nth.call(null,vec__26942_26954,(2),null);
quil.core.camera.call(null,p_x_26955,p_y_26956,p_z_26957,(p_x_26955 + c_x_26947),(p_y_26956 + c_y_26948),(p_z_26957 + c_z_26949),u_x_26951,u_y_26952,u_z_26953);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1463433291334