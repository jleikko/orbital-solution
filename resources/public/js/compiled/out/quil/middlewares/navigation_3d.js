...
var vec__26890 = axis;
var a_x = cljs.core.nth.call(null,vec__26890,(0),null);
var a_y = cljs.core.nth.call(null,vec__26890,(1),null);
var a_z = cljs.core.nth.call(null,vec__26890,(2),null);
var vec__26891 = v;
var x = cljs.core.nth.call(null,vec__26891,(0),null);
var y = cljs.core.nth.call(null,vec__26891,(1),null);
var z = cljs.core.nth.call(null,vec__26891,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__26892,p__26893){
var vec__26896 = p__26892;
var u1 = cljs.core.nth.call(null,vec__26896,(0),null);
var u2 = cljs.core.nth.call(null,vec__26896,(1),null);
var u3 = cljs.core.nth.call(null,vec__26896,(2),null);
var vec__26897 = p__26893;
var v1 = cljs.core.nth.call(null,vec__26897,(0),null);
var v2 = cljs.core.nth.call(null,vec__26897,(1),null);
var v3 = cljs.core.nth.call(null,vec__26897,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__26898_SHARP_){
return (p1__26898_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__26899_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__26900_SHARP_,angle_lr),angle_ud);
...
var map__26907 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__26907__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__26907__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__26909 = cljs.core._EQ_;
var expr__26910 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__26909.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__26910))){
return straight;
} else {
if(cljs.core.truth_(pred__26909.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__26910))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__26909.call(null,quil.middlewares.navigation_3d.space,expr__26910))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__26909.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__26910))){
return up;
} else {
if(cljs.core.truth_(pred__26909.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__26910))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__26909.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__26910))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__26907,map__26907__$1,up,straight){
return (function (p1__26901_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__26901_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__26907,map__26907__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__26912_SHARP_);
});})(initial_state))
);
});
/**
...
var map__26918_26923 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__26918_26924__$1 = ((((!((map__26918_26923 == null)))?((((map__26918_26923.cljs$lang$protocol_mask$partition0$ & (64))) || (map__26918_26923.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26918_26923):map__26918_26923);
var vec__26919_26925 = cljs.core.get.call(null,map__26918_26924__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_26926 = cljs.core.nth.call(null,vec__26919_26925,(0),null);
var c_y_26927 = cljs.core.nth.call(null,vec__26919_26925,(1),null);
var c_z_26928 = cljs.core.nth.call(null,vec__26919_26925,(2),null);
var vec__26920_26929 = cljs.core.get.call(null,map__26918_26924__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_26930 = cljs.core.nth.call(null,vec__26920_26929,(0),null);
var u_y_26931 = cljs.core.nth.call(null,vec__26920_26929,(1),null);
var u_z_26932 = cljs.core.nth.call(null,vec__26920_26929,(2),null);
var vec__26921_26933 = cljs.core.get.call(null,map__26918_26924__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_26934 = cljs.core.nth.call(null,vec__26921_26933,(0),null);
var p_y_26935 = cljs.core.nth.call(null,vec__26921_26933,(1),null);
var p_z_26936 = cljs.core.nth.call(null,vec__26921_26933,(2),null);
quil.core.camera.call(null,p_x_26934,p_y_26935,p_z_26936,(p_x_26934 + c_x_26926),(p_y_26935 + c_y_26927),(p_z_26936 + c_z_26928),u_x_26930,u_y_26931,u_z_26932);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1463305609088