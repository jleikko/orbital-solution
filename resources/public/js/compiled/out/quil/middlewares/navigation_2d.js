...
return cljs.core.merge.call(null,initial_state,p1__27386_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_27387 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_27388 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_27387);
var pos_27389 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_27387);
quil.core.scale.call(null,zoom_27388);

var tr__27310__auto___27390 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_27388) - cljs.core.first.call(null,pos_27389)),(((quil.core.height.call(null) / (2)) / zoom_27388) - cljs.core.second.call(null,pos_27389))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__27310__auto___27390);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1463305609693